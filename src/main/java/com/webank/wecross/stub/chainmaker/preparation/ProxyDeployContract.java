...
public class ProxyDeployContract {
    private static final Logger logger = LoggerFactory.getLogger(ProxyDeployContract.class);
    ...
    public static String getUsage(String chainPath) {
        ...
        return "Usage:\n"
                ...
                + ProxyDeployContract.class.getName()
    ...
    private static void deploy(String chainPath) {
        try {
            ProxyContract proxyContract = new ProxyContract(chainPath);
